...
//	m_stageObjectManager->AddStageObject(S_CLOUD, 1650.0f, 600.0f, 0.0f, 600);
//	m_stageObjectManager->AddStageObject(S_CLOUD, 300.0f, 600.0f, 0.0f, 600);
//	m_stageObjectManager->AddStageObject(S_CLOUD, 700.0f, 500.0f, 0.0f, 600);
////	m_stageObjectManager->AddStageObject(S_GRASS, 250.0f, 900.0f, 0.0f, 600);
	...
	m_stageObjectManager->AddStageObject(S_SCAFFOLD, 700.0f, 800.0f, 0.0f, 600, 0, 1);
	m_stageObjectManager->AddStageObject(S_SCAFFOLD, 700.0f, 800.0f, 0.0f, 600, 1, 1);
	m_stageObjectManager->AddStageObject(S_SCAFFOLD, 700.0f, 800.0f, 0.0f, 600, 2, 1);
	//m_stageObjectManager->AddStageObject(S_SCAFFOLDBASE, SCREEN_WIDTH * 0.7f, 600.0f, 0.0f, 600, 2);
	//m_stageObjectManager->AddStageObject(S_SCAFFOLD, 700.0f, 800.0f, 0.0f, 600, 0, 5);
	//m_stageObjectManager->AddStageObject(S_SCAFFOLD, 700.0f, 800.0f, 0.0f, 600, 1, 5);
	//m_stageObjectManager->AddStageObject(S_SCAFFOLD, 700.0f, 800.0f, 0.0f, 600, 2, 5);
