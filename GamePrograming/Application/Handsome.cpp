...
Handsome::Handsome()
{
	...
	if (!isInitialized)
	{
		m_allTex.idleTex.Load(L"Data/Texture/Motion/Handsome/Idle.png");//待機
		m_allTex.moveTex.Load(L"Data/Texture/Motion/Handsome/Move.png");//歩き
		m_allTex.jumpTex.Load(L"Data/Texture/Motion/Handsome/Jump.png");//ジャンプ
		m_allTex.fallTex.Load(L"Data/Texture/Motion/Handsome/Fall.png");//落下
		m_allTex.landingTex.Load(L"Data/Texture/Motion/Handsome/Landing.png");//着地
		m_allTex.hitstopTex.Load(L"Data/Texture/Motion/Handsome/Hitstop.png");//ヒットストップ
		m_allTex.blowTex.Load(L"Data/Texture/Motion/Handsome/Blow.png");//ふっとび
		m_allTex.havethingsTex.Load(L"Data/Texture/Motion/Handsome/HaveThings.png");//拾う
		m_allTex.throwTex.Load(L"Data/Texture/Motion/Handsome/Throw.png");//投げる
